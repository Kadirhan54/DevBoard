...
namespace DevBoard.Infrastructure.Migrations
{
    ...
    [Migration("20251028180754_DeletedOldRabbitmqEvents")]
    partial class DeletedOldRabbitmqEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevBoard.Domain.Entities.Comment", b =>
                {
                    ...
                    b.Property<string>("CommentedByUserId1")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DevBoard.Domain.Entities.Comment", b =>
                {
                    b.HasOne("DevBoard.Domain.Identity.ApplicationUser", "CommentedByUser")
                        .WithMany("Comments")
                        .HasForeignKey("CommentedByUserId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DevBoard.Domain.Entities.TaskItem", "TaskItem")
                        .WithMany("Comments")
